...
const neonArcadeEvents: EventCard[] = [
  createEvent({
    id: 'spotlight-cut',
    title: '스포트라이트 오버히트',
    description: '조명 사고로 무대가 잠시 암전됩니다.',
    type: 'ban',
    magnitude: 1,
  ...
  createEvent({
    id: 'signal-jam',
    title: '신호 잡음',
    description: '네온 간판에서 날카로운 잡음이 폭주합니다.',
    type: 'ban',
    magnitude: 1,
    target: 'random-active',
  }),
  createEvent({
    id: 'stage-reset',
    title: '무대 점검',
    description: '스태프가 급히 무대를 재정비합니다.',
    type: 'ban',
    magnitude: 1,
...
const hauntedCarnivalEvents: EventCard[] = [
  createEvent({
    id: 'phantom-prank',
    title: '유령의 장난',
    description: '장난기 많은 유령이 무대 뒤편을 어지럽힙니다.',
    type: 'ban',
    magnitude: 1,
    target: 'random-active',
  }),
  createEvent({
    id: 'lantern-snuff',
    title: '등불 소등',
    description: '등불이 스르르 꺼지며 긴장감이 돌기 시작합니다.',
    type: 'ban',
    magnitude: 1,
    target: 'lowest-weight',
  }),
  createEvent({
    id: 'cursed-carousel',
    title: '저주받은 회전목마',
    description: '회전목마에서 기묘한 기계음이 울려 퍼집니다.',
    type: 'ban',
    magnitude: 1,
    target: 'highest-weight',
  }),
...
const starshipHangarEvents: EventCard[] = [
  createEvent({
    id: 'burnout-drill',
    title: '엔진 점검',
    description: '엔진 점검 방송이 격납고 전역으로 울려 퍼집니다.',
    type: 'ban',
    magnitude: 1,
    target: 'random-active',
  }),
  createEvent({
    id: 'gravity-lock',
    title: '중력 고정',
    description: '중력 제어 장치에서 경고등이 켜집니다.',
    type: 'ban',
    magnitude: 1,
    target: 'highest-weight',
  }),
  createEvent({
    id: 'airlock-vent',
    title: '에어록 환기',
    description: '에어록이 열리며 거대한 바람이 몰아칩니다.',
    type: 'ban',
    magnitude: 1,
    target: 'lowest-weight',
  }),
  createEvent({
    id: 'command-ping',
    title: '지휘본부 호출',
    description: '지휘본부로부터 긴급 호출이 전달됩니다.',
    type: 'ban',
    magnitude: 1,
    target: 'random-active',
  }),
