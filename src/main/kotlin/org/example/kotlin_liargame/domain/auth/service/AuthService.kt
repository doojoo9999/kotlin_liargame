...
class AuthService (
    ...
    fun login(request: LoginRequest): TokenResponse {
        ...
        if (unauthenticatedUser != null) {
            // If the user is not authenticated but active, return an error
        ...
        // Check if a user with the given nickname exists but is inactive
        ...
        // If no user with the given nickname exists, create a new one
